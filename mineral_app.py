...
# =============================================================================
# 1. VISUALIZATION ENGINE (NGL.js - Robust Version)
# =============================================================================
...
It features **Interactive 3D Visualization** via NGL.js.
""")
...
if uploaded_file and generate_btn:
    ...
    with zipfile.ZipFile(zip_buffer, "w") as zip_file:
        for i, slab in enumerate(final_slabs):
            ...
            # === RESULT CARD ===
            # We assume NGL is robust now. We use a unique ID for each viewer.
            with st.expander(f"Surface ({hkl_str}) | ID: {i} | Polarity: {dipole_z:.6f} eÅ", expanded=False):
                ...
                with col2:
                    ...
                    # CALL VISUALIZER
                    visualize_with_ngl(slab, height=350, unique_id=f"viewport_{i}")
